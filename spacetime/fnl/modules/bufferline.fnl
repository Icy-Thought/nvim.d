    ...
    {:options {:numbers :none
     ...
     :highlights {:fill [:guifg {:attribute :fg :highlight "#ff0000"}
                  ...
                  :background [:guifg {:attribute :fg :highlight :TabLine}
                               :guibg {:attribute :bg :highlight :TabLine}]
                  :buffer_visible [:guifg {:attribute :fg :highlight :TabLine}
                                   :guibg {:attribute :bg :highlight :TabLine}]
                  :close_button [:guifg {:attribute :fg :highlight :TabLine}
                                 :guibg {:attribute :bg :highlight :TabLine}]
                  :close_button_visible [:guifg {:attribute :fg :highlight :TabLine}
                                         :guibg {:attribute :bg :highlight :TabLine}]
                  ...
                  :duplicate_selected [:guifg {:attribute :fg :highlight :TabLineSel}
                                       ...
                                       :gui :italic]
                  :duplicate_visible [:guifg {:attribute :fg :highlight :TabLine}
                                      :guibg {:attribute :bg :highlight :TabLine}
                                      :gui :italic]
                  ...
                  :modified [:guifg {:attribute :fg :highlight :TabLine}
                             :guibg {:attribute :bg :highlight :TabLine}]
                  :modified_selected [:guifg {:attribute :fg :highlight :Normal}
                                      :guibg {:attribute :bg :highlight :Normal}]
                  :modified_visible [:guifg {:attribute :fg :highlight :TabLine}
                                     :guibg {:attribute :bg :highlight :TabLine}]
                  :separator [:guifg {:attribute :bg :highlight :TabLine}
                              :guibg {:attribute :bg :highlight :TabLine}]
                  :separator_selected [:guifg {:attribute :bg :highlight :Normal}
                                       :guibg {:attribute :bg :highlight :Normal}]
                  :indicator_selected [:guifg {:attribute :fg :highlight :LspDiagnosticsDefaultHint}
                                       :guibg {:attribute :bg :highlight :Normal}]}})
