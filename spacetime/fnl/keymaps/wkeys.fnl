...
(local mappings {"/" ["<CMD>Telescope live_grep<CR>" "Search Project"]
                 ...
                 "f" {:name "Find"
                      "f" ["<CMD>Telescope file_browser<CR>" 2 "Browse Files"]
                      "r" ["<CMD>Telescope frequency<CR>" "List Frequent File"]
                      "R" ["<CMD>Telescope oldfiles<CR>" 2 "Open Recent File"]
                      "s" ["<CMD>w!<CR>" "Save"]}
                 ...
                 "p" {:name "Project"
                      ...
                      "p" ["<CMD>TodoTelescope<CR>" "List Project Tasks"]}
...
(local vmappings {"/" ["<ESC><CMD>lua require('Comment.api').toggle_linewise_op(vim.fn.visualmode())<CR>" "Comment Linewise"]
                  "[" ["<ESC><CMD>lua require('Comment.api').toggle_blockwise_op(vim.fn.visualmode())<CR>" "Comment Blockwise"]})
